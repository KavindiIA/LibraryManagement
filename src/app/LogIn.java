...
public class LogIn {
	...
	/*private void testDBConnection() {
		...
		try {
			...
			System.out.print("DatabaseError: " + e.getMessage());
		} catch (Exception e) {
			System.out.print("GenericError: " + e.getMessage());
		}
	}*/
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(LogIn.class.getResource("/resources/44758162 (1).png")));
