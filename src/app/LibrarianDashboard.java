...
public class LibrarianDashboard {
	...
	public LibrarianDashboard() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(LibrarianDashboard.class.getResource("/resources/twemoji--books (1).png")));
		...
		lblNewLabel.setIcon(new ImageIcon(LibrarianDashboard.class.getResource("/resources/ffgf.jpg")));
