...
public class AdminDashboard {
	...
	public AdminDashboard() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(AdminDashboard.class.getResource("/resources/twemoji--books (1).png")));
		...
		lblNewLabel.setIcon(new ImageIcon(AdminDashboard.class.getResource("/resources/ffgf.jpg")));
